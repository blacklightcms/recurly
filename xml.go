...
// NullString is used for properly handling string types that could be null.
type NullString struct {
	value string
	valid bool
}

// NewString returns NullString with a valid value of s.
func NewString(s string) NullString {
	return NullString{value: s, valid: true}
}

// NewStringPtr returns a new string from a pointer.
func NewStringPtr(s *string) NullString {
	if s == nil {
		return NullString{}
	}
	return NewString(*s)
...
// String returns the string value, regardless of validity. Use Value() if
// you need to know whether the value is valid.
func (s NullString) String() string {
	return s.value
}

// StringPtr returns a pointer to the int value, or nil if the value is not valid.
func (s NullString) StringPtr() *string {
	if s.valid {
		return &s.value
	}
	return nil
...
// Value returns the value of NullInt. The value should only be considered
// valid if ok returns true.
func (s NullString) Value() (value string, ok bool) {
	return s.value, s.valid
}

// Equal compares the equality of two NullInt.
func (s NullString) Equal(v NullString) bool {
	return s.value == v.value && s.valid == v.valid
}
...
// UnmarshalXML unmarshals an int properly, as well as marshaling an empty string to nil.
func (s *NullString) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	var v struct {
...
// MarshalXML marshals NullInts greater than zero to XML. Otherwise nothing is
// marshaled.
func (s NullString) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if s.valid {
