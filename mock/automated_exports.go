...
type AutomatedExportsService struct {
	...
	OnListDates      func(opts *recurly.PagerOptions) Pager
	ListDatesInvoked bool

	OnListFiles      func(date time.Time, opts *recurly.PagerOptions) Pager
...
func (m *AutomatedExportsService) ListDates(opts *recurly.PagerOptions) Pager {
	m.ListDatesInvoked = true
	return m.OnListDates(opts)
}

func (m *AutomatedExportsService) ListFiles(date time.Time, opts *recurly.PagerOptions) Pager {
