...
type CreditPaymentsService struct {
	OnList      func(opts *recurly.PagerOptions) *recurly.CreditPaymentsPager
	ListInvoked bool

	OnListAccount      func(code string, opts *recurly.PagerOptions) *recurly.CreditPaymentsPager
...
func (m *CreditPaymentsService) List(opts *recurly.PagerOptions) *recurly.CreditPaymentsPager {
	m.ListInvoked = true
	return m.OnList(opts)
}

func (m *CreditPaymentsService) ListAccount(code string, opts *recurly.PagerOptions) *recurly.CreditPaymentsPager {
